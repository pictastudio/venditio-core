...
- `src/Packages/Simple`: core models, enums, validations, factories
- `src/Packages/Advanced`: variant system, product types, advanced factories
...
## Models
Models live under `Packages/Simple/Models` and `Packages/Advanced/Models`.
...
- Implementations live in `Packages/Simple/Validations` and `Packages/Advanced/Validations`
...
## Variant System
The advanced product variant system models variant axes and combinations:
