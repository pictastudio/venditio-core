...
namespace PictaStudio\Venditio\Http\Requests\V1\DiscountApplication;
...
class StoreDiscountApplicationRequest extends FormRequest
{
    ...
    {
        return [
            'discount_id' => ['required', 'integer', Rule::exists($this->tableFor('discount'), 'id')],
