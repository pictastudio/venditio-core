...
use PictaStudio\VenditioCore\Models\{Order, User};
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('carts', function (Blueprint $table) {
            ...
            $table->decimal('shipping_fee', 10, 2)->unsigned()->default(0.00)->comment('costo spese di spedizione');
            $table->decimal('payment_fee', 10, 2)->unsigned()->default(0.00)->comment('costo spese di pagamento');
            $table->string('discount_code', 30)->nullable()->comment('codice sconto');
            $table->decimal('discount_amount', 10, 2)->unsigned()->default(0.00)->comment('valore assoluto dello sconto sul carrello');
            $table->decimal('total_final', 10, 2)->unsigned()->comment('totale finale carrello');
